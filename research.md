...
This work is published at NeurIPS 2022, and is available [here](https://arxiv.org/abs/2207.04075). The code and associated RobustNets model set is available [here](https://github.com/sarafridov/RobustNets).
...
This work is published at NeurIPS 2022, and is available [here](https://arxiv.org/abs/2110.02424). The code is available [here](https://github.com/google-research/google-research/tree/master/spectral_bias).
...
This work is published at NeurIPS 2022, and is available [here](https://arxiv.org/abs/2205.04596). The analysis code and associated ImageNet-M dataset of "major mistakes" is available [here](https://github.com/google-research/imagenet-mistakes).
...
This was a fun project I got to do with my [mom](https://med.emory.edu/directory/profile/?u=JFRIDOV) and some wonderful folks in her [lab](https://med.emory.edu/departments/human-genetics/research/fridovich-keil/index.html). This work is published in PLOS One in 2022, and is available [here](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0271593). The code, usage instructions, and sample data are available [here](https://github.com/sarafridov/DAB-quant) and at [protocols.io](dx.doi.org/10.17504/protocols.io.dm6gpb578lzp/v1).
...
This work is published at ICML 2020, and is available [here](https://arxiv.org/abs/2003.02237). Code is available [here](https://github.com/modestyachts/neural_kernels_code)
...
This work is published at NeurIPS 2019, and is available [here](https://papers.nips.cc/paper_files/paper/2019/hash/ee39e503b6bedf0c98c388b7e8589aca-Abstract.html). 
...
This work was based on my undergraduate senior thesis, and is published at GlobalSIP 2018. The paper is available [here](https://arxiv.org/abs/1902.09044) and code is available [here](https://github.com/sarafridov/FingertipVideo). 
